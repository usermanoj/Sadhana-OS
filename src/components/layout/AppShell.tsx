...
export default function AppShell({ activeTab, onTabChange, children }: AppShellProps) {
  return (
    <div className="min-h-screen min-h-dvh overflow-x-hidden bg-ivory">
      {/* Desktop sidebar */}
      ...
      <main
        id="main-content"
        className="flex min-h-screen min-h-dvh justify-center pb-[calc(4.5rem+env(safe-area-inset-bottom))] lg:pb-0 lg:pl-72"
      >
        <div
          key={activeTab}
